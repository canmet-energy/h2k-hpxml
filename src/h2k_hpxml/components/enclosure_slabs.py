...
def get_slabs(h2k_dict, model_data=None):
    ...
    for slab in h2k_slabs:
        ...
        foundation_tot_area = slab_width * slab_length if is_slab_rectangular else slab_floor_area
        ...
        new_slab = {
            ...
            "ExposedPerimeter": (
                foundation_tot_perimeter if slab_exp_perimeter == 0 else slab_exp_perimeter
            ),
            "PerimeterInsulation": {
