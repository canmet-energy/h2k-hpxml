...
def get_basements(h2k_dict, model_data=None):
    ...
    h2k_basements = h2k_basements if isinstance(h2k_basements, list) else [h2k_basements]
    ...
    for basement in h2k_basements:
        ...
        is_basement_rectangular = h2k.get_selection_field(basement, "foundation_rectangular")
        ...
        basement_exp_perimeter = h2k.get_number_field(basement, "foundation_exp_perimeter")
        ...
        foundation_tot_area = (
            basement_width * basement_length if is_basement_rectangular else basement_floor_area
        )
        ...
        h2k.get_number_field(basement, "floors_above_foundation_rval")
        ...
        if slab_ins != "N":
            ...
            if basement_config in perimeter_basement_ins.keys():
                ...
                slab_ins_width = perimeter_basement_ins.get(basement_config, slab_ins_width)
        ...
        new_slab = {
            ...
            "ExposedPerimeter": (
                foundation_tot_perimeter if basement_exp_perimeter == 0 else basement_exp_perimeter
            ),
            "PerimeterInsulation": {
            ...
            "UnderSlabInsulation": {
                ...
                "Layer": {
                    ...
                    **({"InsulationWidth": slab_ins_width} if not insulation_spans_slab else {}),
        ...
        rim_joists_output = get_rim_joists(h2k_floor_headers, "FoundationWall", model_data)
