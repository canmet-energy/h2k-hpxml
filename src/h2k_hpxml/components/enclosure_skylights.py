...
def get_skylights(h2k_skylights, skylight_attachment, model_data):
    ...
    h2k_skylights = h2k_skylights if isinstance(h2k_skylights, list) else [h2k_skylights]
    ...
    for window in h2k_skylights:
        ...
        for _i in range(dup_window_count):
            ...
            window_header_height = h2k.get_number_field(window, "window_header_height")  # [ft]
            window_overhang_width = h2k.get_number_field(window, "window_overhang_width")  # [ft]
            ...
            distance_to_bottom = window_header_height + window_height if has_overhang else 0
