...
Usage:
    python clean_test_data.py                    # Clean everything
    python clean_test_data.py --baseline-only    # Clean only for baseline generation
    python clean_test_data.py --temp-only        # Clean only temp directory
...
# Add current directory to path so we can import test utilities
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python clean_test_data.py                    # Clean all test data
