...
def clean_all_test_data() -> Tuple[bool, List[str]]:
    ...
    if success:
        ...
        print("❌ Failed to clean comparison files")
    ...
    if success:
        ...
        print("❌ Failed to clean pytest cache")
    ...
    if success:
        ...
        print("❌ Failed to clean Python cache")
...
def clean_for_baseline_generation() -> Tuple[bool, List[str]]:
    ...
    print("🎯 Baseline cleanup complete! Ready for fresh golden file generation.")
