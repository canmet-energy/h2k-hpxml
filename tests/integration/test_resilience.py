...
def test_resilience_cli_with_simulation(check_openstudio_bindings):
    ...
    try:
        ...
        cmd = [
            ...
            "--output-path", temp_output_dir,
            "--clothing-factor-summer", "0.5",
            "--clothing-factor-winter", "1.0",
        ...
        # Validate CLI execution
        assert result.returncode == 0, f"Resilience CLI with simulation failed with return code {result.returncode}"
