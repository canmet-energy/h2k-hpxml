...
[canmet-energy/wsl_config](https://github.com/canmet-energy/wsl_config)
bootstrap scripts:
...
1. Open a terminal inside the `nrcan_ubuntu` WSL instance generated by the `wsl_config` scripts
2. Clone the repository in the instance and open it with VSCode:

```shell-session
git clone https://github.com/canmet-energy/h2k-hpxml
code h2k-hpxml
```

3. Either VSCode will prompt you to reopen the repository in a container and you may accept, otherwise press `Ctrl+Shift+P` → **Dev Containers: Rebuild and Reopen in Container**
4. Enter the repo URL: `https://github.com/canmet-energy/h2k-hpxml.git`
5. Wait for the container to build
6. *(Optional — corporate networks)* Add your certs to `.devcontainer/certs/`
...
7. Verify the environment:
   ...
   ```
8. If contributing, configure your git identity:
   ```bash
